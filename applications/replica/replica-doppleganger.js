...
//======================================
//
//  replica-doppleganger.js
//
//  Created by Alezia Kurdis, December 22th, 2023. 
//  (Based on doppleganger.js from Timothy Dedischew, April 21st, 2017)
...
Doppleganger.prototype = {
    ...
    update: function() {
        ...
        try {
            ...
            var currentRotation = MyAvatar.orientation;
            
            var delta = Vec3.subtract(this.avatarReferencePosition, MyAvatar.feetPosition);
            delta.y = -delta.y;
            var currentPosition = Vec3.sum(this.position, delta);
    ...
    start: function(options) {
        ...
        this.avatarReferencePosition = MyAvatar.feetPosition;
        this.orientation = options.orientation || avatar.orientation;
        this.avatarReferenceRotation = MyAvatar.orientation;
        ...
        this.onAddingEntity = function(error, result) {
            ...
            if (!options.position) {
                //this.syncVerticalPosition(); // UNCLEAR WHAT IT DOES????
            }
            if (this.autoUpdate) {
